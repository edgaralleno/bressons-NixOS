...
# Allow unfree packages
  ...
  environment.systemPackages = with pkgs; [
    ...
    cliphist				# works with wl-clipboard to display my clipboard history in rofi. not really that usable
    ...
    # gtk3				# trying more things to mess with the cursor. hopefully having both gtk3&4 won't break things?
    nwg-look				# trying more things to mess with the cursor. first trying install of this w/o gtk3 or 4
    ...
    qemu				# might be provided by pkgs.quickemu. is the emulator framework that quickemu is built on
  ...
  # List services that you want to enable:
    ...
    # services.xserver.enable = true; 	# commenting this out because I have a suspicion I don't need to enable xserver. 
					...
					# that services.xserver.displayManager.sddm 'has been renamed to services.displayManager.sddm'
